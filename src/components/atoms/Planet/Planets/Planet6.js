    ...
    <svg height="100" width="100">
      <defs>
        ...
        <linearGradient id="bodyGradient6-1">
          <stop offset="0%" style={{stopColor: '#fafafa'}}></stop>
          <stop offset="100%" style={{stopColor: '#b15dba'}}></stop>
        </linearGradient>

        <linearGradient id="bodyGradient6-2">
          <stop offset="0%" style={{stopColor: '#eadff5'}}></stop>
          <stop offset="100%" style={{stopColor: '#b15dba'}}></stop>
        </linearGradient>

        <linearGradient id="bodyGradient6-3">
          <stop offset="0%" style={{stopColor: '#d392d5'}}></stop>
          <stop offset="100%" style={{stopColor: '#e02b8e'}}></stop>
        </linearGradient>

        <linearGradient id="bodyGradient6-4">
          <stop offset="0%" style={{stopColor: '#ce5eb6'}}></stop>
          <stop offset="100%" style={{stopColor: '#e71e7d'}}></stop>
        </linearGradient>

        <linearGradient id="bodyGradient6-5">
          <stop offset="0%" style={{stopColor: '#e71e7d'}}></stop>
          <stop offset="60%" style={{stopColor: '#ce5eb6'}}></stop>
        </linearGradient>
      </defs>
