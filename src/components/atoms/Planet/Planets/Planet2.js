    ...
    <svg height="100" width="100">
      <defs>
        <linearGradient id="bodyGradient2" x1="0" y1="0" x2="0" y2="1">
          <stop offset="25%" style={{stopColor: '#3888f7'}}></stop>
          <stop offset="25%" style={{stopColor: '#3c94f8'}}></stop>
          <stop offset="50%" style={{stopColor: '#3c94f8'}}></stop>
          <stop offset="50%" style={{stopColor: '#41a5fb'}}></stop>
          <stop offset="75%" style={{stopColor: '#41a5fb'}}></stop>
          <stop offset="75%" style={{stopColor: '#49bdff'}}></stop>
        </linearGradient>
      </defs>

      <circle cx="13" cy="30" r="9" fill="#a3bbc9"></circle>
