...
const PlanetFive = () => {
  return ( 
    <svg height="100" width="120">
      ...
      <circle cx="25" cy="44" r="2" fill="#ffd6f1"></circle>
      <circle cx="80" cy="88" r="1" fill="#ffd6f1"></circle>
      <circle cx="65" cy="7" r="1" fill="#ffd6f1"></circle>
      <circle cx="27" cy="88" r="1" fill="#ffd6f1"></circle>
    </svg>
  );
}
